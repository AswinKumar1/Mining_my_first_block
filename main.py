...
def load_transactions(mempool_path='/Users/ashwinkumar/Desktop/new/code-challenge-2024-AswinKumar1-main/mempool/'):
    valid_transactions = []
...
def write_output(block_header, coinbase_tx, txids, block_hash):
    with open('/Users/ashwinkumar/Desktop/new/code-challenge-2024-Aswinkumar1-main/output.txt', 'w') as f:
